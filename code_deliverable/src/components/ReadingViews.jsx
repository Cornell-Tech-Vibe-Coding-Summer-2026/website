...
const READINGS = [
    ...
    },
    {
        ...
        authors: 'Shin, Gao, Pang, Lee, Reinecke, Tseng — 2026',
        venue: 'arXiv',
        kind: 'paper',
        url: 'https://arxiv.org/abs/2603.13036',
        abstract: 'Vibe coding pushes generated sites toward the same look, narrowing design diversity across the web. The paper names this homogenization and proposes "productive friction" to keep creative control — the core read for week 1\'s bias-in-tools activity.',
    },
    {
        title: 'Who Controls the Conversation?',
        authors: 'System-prompts study — CHI 2026',
        venue: 'ACM CHI',
        kind: 'paper',
        url: 'https://doi.org/10.1145/3772318.3791726',
        abstract: 'User perspectives on the hidden system prompts that set an AI tool\'s "personality", guardrails, and defaults — the invisible layer shaping what your tool produces before you type anything.',
    },
    {
        title: 'Position is Power',
        authors: 'Neumann, Kirsten, Zafar, Singh — FAccT 2025',
        venue: 'ACM FAccT',
        kind: 'paper',
        url: 'https://doi.org/10.1145/3715275.3732038',
        abstract: 'System prompts are a mechanism of bias: where and how instructions are placed shapes model behaviour and whose interests it serves. Evidence that the tool\'s defaults are never neutral.',
    },
    {
