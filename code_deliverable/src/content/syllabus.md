...
|  | Week 1 Wednesday | Bias in vibe coding | Activity: Test different vibe coding tools and compare outcomes. **Guest:** Remy Stewart (data scientist, Figma AI). | [Interrogating Design Homogenization in Web Vibe Coding](https://arxiv.org/abs/2603.13036) |
...
|  | Week 2 Tuesday | AI safety | Activity: Red-team and adversarially test the AI — push it to produce dark patterns or manipulate users. Where does safety/ethics blur? | [Krauß et al. 2025 (CHI)](https://doi.org/10.1145/3706598.3713083) |
...
|  |  |  |  |  |
| Outcomes: Designing systems that are useful and empowering | Week 3 Monday | Usability Testing — Human & Agent | **Individual, 90-minute activity** on your team's Project 2 prototype: run two short think-aloud human tests and one agent browser test, then edit the strongest evidence into one captioned video of 5 minutes or less. *(Does it work?)* | [Nielsen — 10 Usability Heuristics](https://www.nngroup.com/articles/ten-usability-heuristics/) |
